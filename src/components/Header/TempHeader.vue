...
export default {
    ...
    watch: {
        ...
        settingNames(newValue) {
            this.settingData.settingNames = newValue;
        },
    },
    methods: {
        ...mapActions([
        ...
        handleUpdateCloseDialog() {
            ...
            this.setSettingChosen();
            this.settingData.settingNames = this.settingNames;
        },
        handleChange(data) {
            ...
            if (!this.changeNameSettings) {
                ...
                this.settingData.settingNames[this.currentActiveIndex].name =
                    data;
            }
        },
        setSettingChosen() {
        ...
        async handleDeleteAndCloseSetting({ id, itemDeleted, itemReplaced }) {
            this.closeSetting = { id };
            if (id !== "CC") {
                let cloneRawTableSettings = structuredClone(
                    this.rawTableSettings
                );

                cloneRawTableSettings.active_idx =
                    itemDeleted < itemReplaced
                        ? itemReplaced - 2
                        : itemReplaced - 1;
                cloneRawTableSettings.table_settings.splice(itemDeleted - 1, 1);
